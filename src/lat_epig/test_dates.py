...
def test_no_letters_at_all():
  ...
  assert test_output[0]['dating_from'] == 163
  assert test_output[0]['dating_to'] == 170
  assert test_output[0]['date_not_before'] == 163
  assert test_output[0]['date_not_after'] == 170
...
def test_no_letter():
  ...
  test_output = scrape(args, prevent_write=True)
  assert test_output[0]['dating_from'] == 96
  assert test_output[0]['dating_to'] == 96
  assert test_output[0]['date_not_before'] == 81
  assert test_output[0]['date_not_after'] == 96
...
def test_a_k_dates():
  ...
  assert test_output[0]['dating_from'] == 196
  assert test_output[0]['dating_to'] == 196
  assert test_output[0]['date_not_before'] == 171
  assert test_output[0]['date_not_after'] == 300
...
def test_digit_colon():
  ...
  assert test_output[0]['dating_from'] == -27
  assert test_output[0]['dating_to'] == 37
  assert test_output[0]['date_not_before'] == -27
  assert test_output[0]['date_not_after'] == 37
...
def test_digit_colon_empty():
  ...
  assert test_output[0]['dating_from'] == None
  assert test_output[0]['dating_to'] == None
  assert test_output[0]['date_not_before'] == None
  assert test_output[0]['date_not_after'] == None
...
def test_single_date():
  ...
  assert test_output[0]['dating_from'] == -20
  assert test_output[0]['dating_to'] == -20
  assert test_output[0]['date_not_before'] == -20
  assert test_output[0]['date_not_after'] == -20
...
def test_single_valued_datespan():
  ...
  assert test_output[0]['dating_from'] == -68
  assert test_output[0]['dating_to'] == -68
  assert test_output[0]['date_not_before'] == -68
  assert test_output[0]['date_not_after'] == -68
...
def test_missing_first_date():
  ...
  assert test_output[0]['dating_from'] == None
  assert test_output[0]['dating_to'] == 100
  assert test_output[0]['date_not_before'] == None
  assert test_output[0]['date_not_after'] == 100
...
def test_random__middle_date():
  ...
  assert test_output[0]['dating_from'] == 71
  assert test_output[0]['dating_to'] == 100
  assert test_output[0]['date_not_before'] == 71
  assert test_output[0]['date_not_after'] == 100
